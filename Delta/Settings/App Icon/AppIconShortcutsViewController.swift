...
private extension AppIconShortcutsViewController
{
    func prepareDataSource()
    {
        ...
        placeholderView.textLabel.text = "no_shortcut".localizable
        placeholderView.detailTextLabel.text = "no_shortcut_text".localizable
        self.dataSource.placeholderView = placeholderView
    }
    
    func configureModeCell(_ cell: SwitchTableViewCell, for indexPath: IndexPath)
    {
        cell.textLabel?.text = "games_shortcut_recent".localizable
...
extension AppIconShortcutsViewController
{
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String?
    {
        ...
        {
        case 0: return nil
        case 1: return "Shortcuts".localizable
        default:
    ...
    override func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String?
    {
        ...
        {
        case (0, .recent): return "shortcut_home".localizable
        case (0, .manual): return "shortcut_home_games".localizable
        case (1, .recent) where self.shortcutsDataSource.itemCount == 0: return "shortcut_no_game".localizable
        case (1, .recent): return " " // Return non-empty string since empty string changes vertical offset of section for some reason.
        case (1, .manual): return "shortcut_max".localizable
